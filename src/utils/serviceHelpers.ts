...
// Initial fallback/catalog data for seeding Firestore
export const DEFAULT_SERVICES_DATA: ServiceCategory[] = [
  {
    id: 'entrepreneur',
    ...
    subServices: [
      ...
      { id: 'opc', name: 'One Person Company (OPC)', description: 'Ideal legal structure for high-prostige sole founders seeking corporate status.' },
